...
@GetMapping("/applied-jobs-details/{cid}")
public List<JobPostDto> getAppliedJobsDetails(@PathVariable int cid)
{
return jss.getAppliedJobDetails(cid);
}
