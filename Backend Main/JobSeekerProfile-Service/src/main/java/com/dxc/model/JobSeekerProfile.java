...
public class JobSeekerProfile {
	...
	@Transient
	private List<JobSearchAndApplyDto> jsa=new ArrayList<>();
	...
	public JobSeekerProfile(int cid, String firstname, String lastname, int age, String email, String contactnumber,
			String location, String qualification, String skill1, String skill2, String experience,
			List<JobSearchAndApplyDto> jsa) {
		super();
		this.cid = cid;
	...
	public List<JobSearchAndApplyDto> getJsa() {
		return jsa;
	}

	public void setJsa(List<JobSearchAndApplyDto> jsa) {
		this.jsa = jsa;
	}
