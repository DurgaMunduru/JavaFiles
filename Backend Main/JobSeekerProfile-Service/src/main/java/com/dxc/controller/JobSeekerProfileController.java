...
public class JobSeekerProfileController {
	...
	public JobSeekerProfile getbyFirstName(@PathVariable String firstname) {
		return service.getByFirstName(firstname);
	}
	
	@GetMapping("/profile/{email}")
	public JobSeekerProfile getByEmail(@PathVariable String email) {
